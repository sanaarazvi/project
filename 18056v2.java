...
class Cafe {
    ...
    public Cafe() {
        ...
        menu = new Vector<>();
        menu.add(new MenuItem(1, "Cake", 3.00));
        menu.add(new MenuItem(2, "Coffee", 1.00));
        menu.add(new MenuItem(3, "Maggie", 2.00));
        menu.add(new MenuItem(4, "Lemon Mojito", 1.40));
    }
